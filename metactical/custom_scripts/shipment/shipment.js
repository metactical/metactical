...
metactical.ShipmentController = class ShipmentController extends frappe.ui.form.Controller{
	refresh() {
...
extend_cscript(cur_frm.cscript, new metactical.ShipmentController({frm: cur_frm}));

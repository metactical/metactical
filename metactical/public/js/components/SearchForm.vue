                ...
                <div class="col-md-9">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <!-- Email -->
                            <div class="form-group">
                                <input type="text" class="form-control" id="search-email" :readonly="freeze_fields"
                                    v-model="customer.email" placeholder="Email">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <!-- Company Name -->
                                <input type="text" class="form-control" id="search-company" :readonly="freeze_fields"
                                    v-model="customer.company" placeholder="Company Name">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <!-- First Name -->
                            <div class="form-group">
                                <input type="text" class="form-control" id="search-first_name" :readonly="freeze_fields"
                                    v-model="customer.first_name" placeholder="First Name">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <!-- Last Name -->
                            <div class="form-group">
                                <input type="text" class="form-control" id="search-last_name" :readonly="freeze_fields"
                                    v-model="customer.last_name" placeholder="Last Name">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <!-- Territory -->
                            <div class="form-group">
                                <select class="form-control" id="search-territory" :readonly="freeze_fields"
                ...
                <div class="col-md-3">
                    <div class="d-flex justify-content-end">
                        ...
                        <div class="d-flex flex-column">
                            <button type="button" class="btn btn-secondary mb-2" @click="clearCustomer">Clear
                                Customer</button>
                            <button type="button" class="btn btn-success" @click="createCustomer"
                                :disabled="isDisabled">Create Customer</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        searchCustomer() {
            ...
            if (!this.customer.phone_number && !this.customer.email && !this.customer.first_name && !this.customer.last_name) {
            ...
            $(`#search-first_name`).removeClass('is-invalid')
            $(`#search-last_name`).removeClass('is-invalid')

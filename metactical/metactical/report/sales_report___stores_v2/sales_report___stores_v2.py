...
def execute(filters=None):
	...
	opening_closing = get_data(filters)
...
def get_data(filters):
	...
	if filters.get("item_code"):
		conditions += " and sales_invoice_item.item_code = '{}'".format(filters.get("item_code"))
	if filters.get("pos_profile"):
		conditions += " and sales_invoice.pos_profile = '{}'".format(filters.get("pos_profile"))

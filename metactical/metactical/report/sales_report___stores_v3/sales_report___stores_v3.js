...
frappe.query_reports["Sales Report - Stores V3"] = {
	"filters": [
		{
...
function create_material_transfer(pos_profile, to_date, item_code){
	frappe.call({
		method: "metactical.metactical.report.sales_report___stores_v3.sales_report___stores_v3.create_material_transfer",
		args: {

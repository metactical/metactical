			...
			if d.get('price_list_rate') > 0:
				...
				if price_list_rate is not None:
					...
					if rate_discount >= 0.15:
						...
						row['warehouse'] = get_name_mapping().get(d.source, d.source)
						row['si_name'] = d.name
...
def get_data(filters):
	...
	data = frappe.db.sql("""select c.item_code, c.item_name, c.qty, c.price_list_rate, c.rate, c.discount_percentage,
		c.uom, c.ifw_retailskusuffix, c.ifw_location, c.warehouse, p.source,
...
def get_name_mapping():
	return {
		"Store - Camo - Edmonds": "Camo - Edm",
		"Store - Camo - Downtown": "Camo - DT",
		"Store - Camo - Victoria": "Camo - Vic",
		"Store - Camo - Queen": "Camo - Queen",
		"Store - Gorilla - Vancouver": "Gorilla - Van",
		"Store - Camo - Montreal": "Camo - MTL",
		"Store - Camo - Bermondsey": "Camo - Bermonsy",
		"Store - Camo - Oshawa": "Camo - Oshawa"
	}

...
frappe.ui.form.on('Reorder Qty From Excel', {
	...
	download_template(frm) {
		var dialog = new frappe.ui.Dialog({
			...
			primary_action: (values) => {
				let method = "/api/method/metactical.metactical.doctype.reorder_qty_from_excel.reorder_qty_from_excel.download_template";

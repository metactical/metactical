...
frappe.ui.form.on('Cycle Count V3', {
...
function fetch_expected_qty(frm, cdt, cdn) {
	...
	if (frm.doc.warehouse && child.item_code) {
		...
		frappe.call({
			method: "metactical.metactical.doctype.cycle_count_v3.cycle_count_v3.get_expected_qty",
...
function get_items_from_template_sku(template_sku, frm) {
	frappe.call({
		method: "metactical.metactical.doctype.cycle_count_v3.cycle_count_v3.get_items_from_template_sku",
		args: {
...
function get_items_from_retail_sku(retail_sku, frm) {
	frappe.call({
		method: "metactical.metactical.doctype.cycle_count_v3.cycle_count_v3.get_items_from_retail_sku",
		args: {

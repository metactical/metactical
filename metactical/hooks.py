...
fixtures = [{
		...
		"filters": [["name", "in", [
			...
			"Item-custom_website",
			"Item-custom_publishing",
			"Item-custom_restrictions_templatelevel",
			"Item-custom_integrations",
			"Item-custom_sales_velocity",
			"Item-custom_column_break_9ohpy",
			"Item-custom_gpd__ordering",
			"Item-custom_legacy__sync",
			"Item-custom_stock_levels",
			"Item-custom_stock_levels_html",
			"Item-custom_opening__rates",
			"Item-custom_identity",
			"Item-custom_website_sync",
			"Item-custom_column_break_30tfc",
			"Item-custom_column_break_gcig5",
   			"Item-custom_purchasing",
			"Item-custom_notes",
			"Item-custom_column_break_smng0",
			"Item-custom_reorder_analytics",
			"Item-custom_column_break_fyzfp",
			"Item-custom_advanced",
			"Item-custom_lifecycle__merchandising",
			"Item-custom_column_break_5c95u",
			"Item-custom_sales",
			"Item-custom_fixed_asset",
			"Item-custom_column_break_yt8sa",
			"Item-custom_allowances",
			"Item-custom_section_break_twt8l",
